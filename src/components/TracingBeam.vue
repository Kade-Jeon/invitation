    ...
    <div ref="tracingBeamRef" :class="cn('relative w-full max-w-4xl mx-auto h-full', $props.class)">
        <div class="absolute -left-4 top-3 md:-left-12">
            ...
            <svg :viewBox="`0 0 20 ${svgHeight}`" width="20" :height="svgHeight" class="ml-4 block" aria-hidden="true">
                ...
                <path :d="`M 1 0V -36 l 18 24 V ${svgHeight * 0.8} l -18 24V ${svgHeight}`" fill="none"
                    stroke="url(#gradient)" stroke-width="1.25" class="motion-reduce:hidden"></path>
                <defs>
                    <linearGradient id="gradient" gradientUnits="userSpaceOnUse" x1="0" x2="0" :y1="spring.y1"
                        :y2="spring.y2">
