<template>
    <div class="flex h-[40rem] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-transparent">
        ...
        <div class="relative h-40 w-[40rem]">
            ...
            <div
                class="absolute inset-0 size-full bg-trasparent [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)] dark:bg-black">
            </div>
        </div>
    </div>
</template>
